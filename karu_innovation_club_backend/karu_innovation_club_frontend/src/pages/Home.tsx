    ...
    <div className="home text-center relative overflow-hidden">
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="mt-8 p-6 bg-white rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4">Message from the Patron</h2>
        ...
        <div className="mt-8 p-6 bg-white rounded-lg shadow-lg">
          ...
          <div className="flex justify-between items-center">
            <div className="text-left">
              <p><strong>chairman:</strong>victor wambugu</p>
            </div>
            <div className="flex">
              <img src="/src/assets/images/blb.jpg" alt="Patron" className="w-20 h-20 object-cover rounded-full mr-4" />
            </div>
        ...
        <div className="mt-8 flex justify-between items-center overflow-hidden relative">
          <div className="leader-marquee whitespace-nowrap flex space-x-4 animate-marquee">
            <img src="/src/assets/images/club_logo.jpg" alt="Leader 1" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/club_logo.jpg" alt="Leader 2" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/club_logo.jpg" alt="Leader 1" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/club_logo.jpg" alt="Leader 2" className="inline-block w-20 h-20 object-cover rounded-full" />
            {/* Add more leader images for leaders */}
          </div>
          <div className="community-marquee whitespace-nowrap flex space-x-4 animate-marquee-reverse">
            <img src="/src/assets/images/android.jpg" alt="android" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/cybersecurity.jpg" alt="Cybersecurity" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/iot.jpg" alt="iot" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/ai.jpg" alt="ai" className="inline-block w-20 h-20 object-cover rounded-full" />
            <img src="/src/assets/images/webdev.jpg" alt="webdev" className="inline-block w-20 h-20 object-cover rounded-full" />
            {/* Add more community images  */}
          </div>
        </div>
      </div>
    </div>
